...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        {
            var history = GetIndicatorWarmUpHistory(symbol, indicator, period, out var needsConsolitador);
            ...
            WarmUpIndicatorImpl(symbol, period, onDataConsolidated, history, needsConsolitador);
        }
        ...
        private IEnumerable<Slice> GetIndicatorWarmUpHistory(Symbol symbol, IIndicator indicator, TimeSpan timeSpan, out bool needsConsolidator)
        {
            needsConsolidator = false;
            ...
            if (periods.HasValue && periods != 0)
            {
                ...
                needsConsolidator = resolution.ToTimeSpan() != timeSpan;
        ...
        private void WarmUpIndicatorImpl<T>(Symbol symbol, TimeSpan period, Action<T> handler, IEnumerable<Slice> history, bool needsConsolidator)
            where T : class, IBaseData
        {
            IDataConsolidator consolidator;
            if (!needsConsolidator)
            {
