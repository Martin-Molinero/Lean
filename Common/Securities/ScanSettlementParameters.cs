...
{
    /// <summary>
    /// The settlement model <see cref="ISettlementModel.ScanSettlement(ScanSettlementParameters)"/> parameters
    /// </summary>
    public class ScanSettlementParameters
    {
        /// <summary>
        ...
        public ScanSettlementParameters(SecurityPortfolioManager portfolio, Security security, DateTime timeUtc)
        {
            Portfolio = portfolio;
            Security = security;
            TimeUtc = timeUtc;
