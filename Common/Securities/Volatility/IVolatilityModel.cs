...
namespace QuantConnect.Securities
{
    ...
    public interface IVolatilityModel
    {
        ...
        IEnumerable<HistoryRequest> GetHistoryRequirements(Security security, DateTime utcTime, Resolution resolution);
    }
    ...
    public static class VolatilityModel
    {
        ...
        private sealed class NullVolatilityModel : IVolatilityModel
        {
            ...
            public IEnumerable<HistoryRequest> GetHistoryRequirements(Security security, DateTime utcTime, Resolution resolution) { return Enumerable.Empty<HistoryRequest>(); }
        }
    }
}