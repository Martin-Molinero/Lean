...
namespace QuantConnect.Tests.Common
{
    ...
    public class OptionPriceModelTests
    {
        ...
        class DummyVolatilityModel : IVolatilityModel
        {
            ...
            public IEnumerable<HistoryRequest> GetHistoryRequirements(Security security, DateTime utcTime, bool isExtendedMarketHours,
                                                                      DataNormalizationMode dataNormalizationMode, Resolution resolution)
            {
