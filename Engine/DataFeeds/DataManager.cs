...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class DataManager : IDataManager
    {
        ...
        /// </summary>
        public IEnumerable<SubscriptionDataConfig> Subscriptions => _subscriptionManagerSubscriptions.Select(x => x.Key);

        /// <summary>
        /// Returns true if the given subscription data config is already present
        /// </summary>
        public bool TryAdd(SubscriptionDataConfig config)
        {
        ...
        /// Returns true if the given subscription data config is already present
        /// </summary>
        public bool ContainsKey(SubscriptionDataConfig config)
        {
