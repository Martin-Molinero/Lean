...
namespace QuantConnect.Lean.Engine.DataFeeds.Enumerators
{
    ...
    public class SubscriptionFilterEnumerator : IEnumerator<BaseData>
    {
        ...
        /// <param name="isExtendedMarketHours">Subscription configuration ExtendedMarketHours</param>
        ...
        public static SubscriptionFilterEnumerator WrapForDataFeed(IResultHandler resultHandler, IEnumerator<BaseData> enumerator, Security security, DateTime endTime, bool isExtendedMarketHours)
        {
            var filter = new SubscriptionFilterEnumerator(enumerator, security, endTime, isExtendedMarketHours);
        ...
        /// <param name="endTime">The end time of the subscription</param>
        /// <param name="isExtendedMarketHours">Subscription configuration ExtendedMarketHours</param>
        public SubscriptionFilterEnumerator(IEnumerator<BaseData> enumerator, Security security, DateTime endTime, bool isExtendedMarketHours)
        {
        ...
        public bool MoveNext()
        {
            while (_enumerator.MoveNext())
            {
                ...
                if (current != null)
                {
                    ...
                    if (current.DataType != MarketDataType.Auxiliary && !_exchange.IsOpenDuringBar(current.Time, current.EndTime, _isExtendedMarketHours))
                    {
                        continue;
                    }
