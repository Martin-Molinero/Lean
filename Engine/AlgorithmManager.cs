...
namespace QuantConnect.Lean.Engine
{
    ...
    public class AlgorithmManager
    {
        ...
        public void Run(AlgorithmNodePacket job, IAlgorithm algorithm, DataManager dataManager, ITransactionHandler transactions, IResultHandler results, IRealTimeHandler realtime, ILeanManager leanManager, IAlphaHandler alphas, CancellationToken token)
        {
            //Initialize:
            _dataPointCount = 0;
        ...
        private IEnumerable<TimeSlice> Stream(IAlgorithm algorithm, DataManager dataManager, IResultHandler results, CancellationToken cancellationToken)
        {
            ...
            foreach (var timeSlice in dataManager)
            {
                if (!setStartTime)
                {
                    setStartTime = true;
