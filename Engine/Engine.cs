            ...
            try
            {
                ...
                if (initializeComplete)
                {
                    ...
                    try
                    {
                        ...
                        var complete = isolator.ExecuteInWorkerWithTimeLimit(_algorithmHandlers.Setup.MaximumRuntime, () =>
                        {
                            try
                            {
                                //Run Algorithm Job:
                        ...
                        }, job.Controls.RamAllocation, workerThread, algorithmManager.TimeLoopWithinLimits);
